...
export function Header() {
  ...
  // On peut masquer le header sur certaines pages si nécessaire, 
  // mais ici l'utilisateur le veut "toujours pareil".
  ...
  return (
    <nav className="fixed top-0 right-0 p-4 flex gap-3 z-50">
      ...
      <Link 
        href="/" 
        className={`text-[11px] font-bold uppercase tracking-wider py-1.5 px-3 rounded transition-all shadow-sm ${
          pathname === "/" 
