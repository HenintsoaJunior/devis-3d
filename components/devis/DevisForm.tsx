  ...
  const steps = [
    <section key="s1" style={{ display: "grid", gap: "var(--spacing-md)" }}>
      <div className="form-group">
        <label htmlFor="etablissement" className="form-label">Type d'établissement</label>
        ...
        {errors.etablissement && <span className="error-message">{errors.etablissement.message || "Établissement invalide"}</span>}
      </div>
      <div className="form-group">
        ...
        {errors.surface && <span className="error-message">{errors.surface.message || "La surface doit être supérieure à 0"}</span>}
      </div>
    </section>,
    <section key="s2" style={{ display: "grid", gap: "var(--spacing-md)" }}>
      ...
      {errors.nuisibles && <span className="error-message">{errors.nuisibles.message || "Sélectionnez au moins un nuisible"}</span>}
      <fieldset className="card" style={{ padding: "var(--spacing-md)" }}>
    ...
    <section key="s3" style={{ display: "grid", gap: "var(--spacing-md)" }}>
      ...
      <div className="form-group">
        ...
        {errors.telephone && canShowContactFieldError("telephone") && <span className="error-message">{errors.telephone.message || "Téléphone invalide"}</span>}
      </div>
      <div className="form-group">
        ...
        <span className="form-hint">{(messageValue ?? "").length}/500 caractères</span>
      ...
      {!confirmationId && (
        <div className="card">
          <div className="card-header">
            <h3 style={{ margin: 0, fontSize: "var(--font-size-xl)" }}>Demande de devis</h3>
